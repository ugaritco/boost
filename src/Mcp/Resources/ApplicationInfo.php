...
namespace Ugarit\Boost\Mcp\Resources;
...
class ApplicationInfo extends Resource
{
     ...
     */
    protected string $description = 'Comprehensive application information including PHP version, Ugarit version, database engine, and all installed packages with their versions in the application.';
