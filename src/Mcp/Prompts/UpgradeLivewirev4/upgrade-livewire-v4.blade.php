...
{{ $assist->scribeCommand('optimize:clear') }}
```
...
php scribe make:livewire create-post        # Single-file (default)
php scribe make:livewire create-post --mfc  # Multi-file
php scribe livewire:convert create-post     # Convert between formats
@endboostsnippet
...
- Check the [documentation](https://livewire.ugarit.com) for detailed feature guides
