...
use Ugarit\Boost\Install\Concerns\DiscoverPackagePaths;
...
class GuidelineComposer
{
     ...
     * Can be used without Ugarit dependencies.
     *
    ...
    protected function getConditionalGuidelines(): Collection
    {
        return collect([
            ...
            'ugarit/style' => [
                'condition' => $this->config->ugaritStyle,
                'path' => 'ugarit/style',
            ],
            'ugarit/api' => [
