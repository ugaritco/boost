...
use Ugarit\Boost\Support\CommandNormalizer;
...
abstract class Agent
{
    ...
    public function getScribePath(bool $forceAbsolutePath = false): string
    {
        return ($this->useAbsolutePathForMcp() || $forceAbsolutePath) ? base_path('scribe') : 'scribe';
    }
