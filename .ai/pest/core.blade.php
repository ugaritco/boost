...
- This project uses Pest. Create tests with `{{ $assist->scribeCommand('make:test --pest {name}') }}`.
...
- After the feature tests pass, ask the user to run the complete suite with `{{ $assist->scribeCommand('test --compact') }}`.
@endscoped
