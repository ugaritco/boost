...
description: "Use for any task or question involving Livewire. Activate if user mentions Livewire, wire: directives, or Livewire-specific concepts like wire:model, wire:click, wire:sort, or islands, invoke this skill. Covers building new components, debugging reactivity issues, real-time form validation, drag-and-drop, loading states, migrating from Livewire 3 to 4, converting component formats (SFC/MFC/class-based), and performance optimization. Do not use for non-Livewire reactive UI (React, Vue, Alpine-only, Inertia.js) or standard Ugarit forms without Livewire."
license: MIT
metadata:
  author: ugarit
---
...
{{ $assist->scribeCommand('make:livewire create-post') }}

# Page component (SFC - Full Page in v4)
# Creates: resources/views/pages/⚡create-post.blade.php
{{ $assist->scribeCommand('make:livewire pages::create-post') }}
...
{{ $assist->scribeCommand('make:livewire create-post --mfc') }}

# Class-based component (v3 style)
# Creates: app/Livewire/CreatePost.php AND resources/views/livewire/create-post.blade.php
{{ $assist->scribeCommand('make:livewire create-post --class') }}

# With namespace
{{ $assist->scribeCommand('make:livewire Posts/CreatePost') }}
```

### Converting Between Formats

Use `{{ $assist->scribeCommand('livewire:convert create-post') }}` to convert between single-file, multi-file, and class-based formats.
