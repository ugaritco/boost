...
Fetch `https://ugarit.com/framework/docs/mocking` for Ugarit's fakes, facade doubles, and fake assertions. Confirm each name before using it.
...
@if($pest)
Import the mock function before you use it: `use function Pest\Ugarit\mock;`.
@else
