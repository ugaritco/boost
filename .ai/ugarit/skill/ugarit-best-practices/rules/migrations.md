...
## Generate Migrations with Scribe

Use `php scribe make:migration` to generate the timestamped filename and migration structure.

```bash
php scribe make:migration create_posts_table
php scribe make:migration add_slug_to_posts_table
```
