...
For icons not available in Heroicons, use [Lucide](https://lucide.dev/). Import the icons you need with the Scribe command:

```bash
{{ $assist->scribeCommand('flux:icon crown grip-vertical github') }}
```
